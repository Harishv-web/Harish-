...
const PWA_VERSION = '2026.08.27.1';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  initialiseBackground(); initialiseBackToTop(); initialiseAssistant(); initialiseVisitorAnalytics(); initialiseContactForm(); registerPwa();
